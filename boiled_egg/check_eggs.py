...
ev_hia = np.array([-2.64497678, 3.62300812, 141.27928864, 1.11967626,
	144.22556707])
...
ellipse_hia = Ellipse((x, y), 2*a, 2*b, angle=np.degrees(theta), fill=False,
	color="black")
filled_ellipse_hia = Ellipse((x, y), 2*a, 2*b, angle=np.degrees(theta),
	fill=True, color="white")

ev_bbb = np.array([-2.48156312, 3.20928199, 79.25676677, 4.3657658,
	81.98390281])
...
ellipse_bbb = Ellipse((x, y), 2*a, 2*b, angle=np.degrees(theta), fill=False,
	color="black")
filled_ellipse_bbb = Ellipse((x, y), 2*a, 2*b, angle=np.degrees(theta),
	fill=True, color="yellow")

plt.grid()
plt.scatter(hia_features[:,0], hia_features[:,1], c=hia_labels,
	cmap=matplotlib.colors.ListedColormap(hia_colors), alpha=0.5)
...
plt.grid()
plt.scatter(bbb_features[:,0], bbb_features[:,1], c=bbb_labels,
	cmap=matplotlib.colors.ListedColormap(bbb_colors), alpha=0.5)
...
plt.scatter(hia_features[:,0], hia_features[:,1], c=hia_labels,
	cmap=matplotlib.colors.ListedColormap(hia_colors), alpha=0.5)
plt.scatter(bbb_features[:,0], bbb_features[:,1], c=bbb_labels,
	cmap=matplotlib.colors.ListedColormap(bbb_colors), alpha=0.8)
plt.xlim((-10, 210))
plt.ylim((-3.5, 8.0))
plt.xlabel("TPSA")
plt.ylabel("LogP")
